...
namespace Rent4Students.Infrastructure.Migrations
{
    ...
    [Migration("20250205133155_UpdateRentHistoryStorePhotos")]
    partial class UpdateRentHistoryStorePhotos
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Rent4Students.Domain.Entities.StoredPhoto", b =>
                {
                    ...
                    b.HasIndex("RentHistoryId")
                        .IsUnique()
                        .HasFilter("[RentHistoryId] IS NOT NULL");
